...
if(nimiSisalto.value === '' || asiaSisalto.value === ''){
  ...
  virhe.innerHTML = 'täyta kaikki kentät';
  kurssinappi.style.background = 'red';
  kurssinappi.value= 'Virhe! En lisannyt tietoa';
...
ul.children[0].innerHTML = '<input type="checkbox" id="tehta" checked>HTMLtunnit pidetty';
...
ul. children[1] .innerHTML = '<input type="checkbox" id="tehtb"> Cheacked>Css" ;
}
...
ul.children[3].innerHTML = '<input type="checkbox" checked>CI/CD tunnit pidetty';

}else{
ul.children[3].innerHTML ="tehtd" '<input type="checkbox" id="tehtd">CI/CD' ;
}
